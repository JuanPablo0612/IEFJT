...
fun AddTypeDialog(
    ...
    var isValidName = name.isNotBlank()
    var isValidImageUrl = Patterns.WEB_URL.matcher(imageUrl).matches()

    AlertDialog(
        onDismissRequest = onDismiss,
        confirmButton = {
            Button(onClick = { onConfirm(name, imageUrl) }, enabled = isValidName && isValidImageUrl) {
